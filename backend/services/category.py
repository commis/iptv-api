...
class CategoryManager:
    ...
    def __init__(self):
        ...
        self._categories: Dict[str, Dict[str, object]] = {
            ...
            "精品": {
                "channels": [
                    "风云音乐", "风云足球", "风云剧场", "怀旧剧场", "兵器科技", "世界地理", "央视台球",
                    "第一剧场", "女性时尚", "电视指南", "老故事", "中学生","发现之旅"
                ],
                "excludes": [],
            },
            "卫视": {
            ...
            "纪实": {
                "channels": [
                    "新动力量创一流", "环球旅游", "军事评论", "农业致富", "探索发现", "地理中国", "人与自然",
                    "中国村庄", "自然传奇", "航拍中国第二季", "之江纪录"
                ],
                "excludes": [],
            },
            "体育": {
            ...
            "电影": {
                "channels": [
                    ...
                    "黑莓电影", "南方影视", "经典香港电影", "抗战经典影片", "新片放映厅", "高清大片",
                    "东森电影", "凤凰电影", "龙华电影",
                ],
                "excludes": [
                    "淘剧场", "淘娱乐", "韩国电影1", "韩国电影2", "倩女幽魂道道道",
                    "倩女幽魂人间道", "倩女幽魂妖魔道",
                ],
            },
            "儿童": {
                "channels": [
                    "哈哈炫动", "金鹰卡通", "卡酷少儿", "优漫卡通", "黑龙江少儿", "浙江少儿",
                ],
                "excludes": ["韩国EBS少儿"],
            },
