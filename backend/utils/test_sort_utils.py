...
from utils.sort_util import mixed_sort
...
class TestMixedSortKey(unittest.TestCase):
    ...
    def test_pure_chinese(self):
        ...
        self.assertEqual(["北京", "广州", "上海", "深圳"], mixed_sort(city_lst))
    ...
    def test_complex_mixed(self):
        ...
        self.assertEqual(expected, mixed_sort(lst))
