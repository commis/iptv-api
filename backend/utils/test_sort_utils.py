...
class TestMixedSortKey(unittest.TestCase):
    ...
    def test_pure_chinese(self):
        ...
        self.assertEqual(["北京", "广州", "上海", "深圳"], sorted(city_lst, key=mixed_sort_key))

        # 场景2：人名拼音排序（李四(li) < 王五(wang) < 张三(zhang)）
        name_lst = ["张三", "李四", "王五", "航拍中国第一季", "航拍中国第三季", "航拍中国第二季"]
        self.assertEqual(['航拍中国第一季', '航拍中国第二季', '航拍中国第三季', '李四', '王五', '张三'],
                         sorted(name_lst, key=mixed_sort_key))
    ...
    def test_mixed_chinese_number(self):
        ...
        sorted_lst = sorted(lst, key=mixed_sort_key)
        self.assertEqual(['美5利坚', '美67利坚', '日8本', '中45国', '中123国'], sorted_lst)
    ...
    def test_complex_mixed(self):
        ...
        self.assertEqual(expected, sorted(lst, key=mixed_sort_key))
